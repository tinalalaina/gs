...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
 ...
 <nav class="navbar navbar-light bg-success fixed-top">
  <nav class="container-fluid">
    ...
    <a class="btn btn-dark" href="../1/14.php"  class="fst-italic">Accueil</a>
    <!--fin cherche-->
...
<!-- nav x-->
    ...
    <nav class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      <nav class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"></h5>évènements
...
<tr><td>Email</td><td>Mot de passe</td><td></td></tr>
