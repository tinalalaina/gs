    ...
    <table border=""1>
        ...
        <tr>
            ...
            <td><textarea readonly="true" cols="50" rows="10" > <?php echo($commentaire) ?></textarea></td>
             <td> <img whidth="250px"height="250px"  src="../1/sary/<?php echo($nomphoto)?>" alt=""> </td>
        </tr>
    </table>
    <h5 align="center"><p> a étè enregistreé avec succée  </p> </h5>

  
    <a class="btn btn-primary" aria-current="page" href="4.php"> Accueil</a>
    <a class="btn btn-secondary" href="premier.php">Ajouter</a>
    <a class="btn btn-success" href="4.php">Lister</a>
